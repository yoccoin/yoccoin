...
uint256 hashGenesisBlock("0xf14a535b827086aeb27d21463a6ae0aa1162c01e74d21222caf607c3d2837299");
...
{
    // Yocoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "YoCoin Genesis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	    ...
	    assert(block.hashMerkleRoot == uint256("0x443ea2596c925973deeb7e35142854215fc17cc93aa78d75122de002581cfb17"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xdc, 0xcc, 0xbf, 0xeb };
